...
import { LogOut, Bookmark, History, Settings, Mail, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen px-4 md:px-6 lg:px-8 py-10 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="bg-bg-surface border border-border-subtle rounded-3xl p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          <div className="w-20 h-20 rounded-2xl overflow-hidden border-2 border-border-subtle shrink-0 shadow-lg">
            <Avatar src={session.user?.image} name={session.user?.name} size={80} />
          </div>
